...
// EEPROM Object's
#ifdef RF_NODE
const uint8_t  EEMEM ee_NodeID  = OD_DEFAULT_ADDR;                      // Device Address
const uint16_t EEMEM ee_GroupID = OD_DEFAULT_GROUP;                     // Group ID
const uint8_t  EEMEM ee_Channel = OD_DEFAULT_CHANNEL;                   // Channel
#endif  //  RF_NODE
