...
//  28  PB12    31    * ENC_NSS2
//  29  PB13    30    * ENC_SCLK2
//  30  PB14    29    * ENC_MISO2
//  31  PB15    28    * ENC_MOSI2
// GPIOC
//  45  PC13    14
//  46  PC14    13      OSC32 In
...
#define HAL_DIO_MAPPING             {27, 26, 18, 16, 7, 6, 5, 4, 3, 2, 1, 0,        /* PB11, PB10, PB2, PB0, PA7 - PA0 */ \
...
// ENC Section
#define HAL_USE_SPI2                1   // SPI2
#define ENC_USE_SPI                 2   // PB13-PB15
#define ENC_NSS_PIN                 28  // PB12
#define ENC_SELECT()                GPIOB->BRR = GPIO_Pin_12
#define ENC_RELEASE()               {while(SPI1->SR & SPI_SR_BSY); GPIOB->BSRR = GPIO_Pin_12;}
