...
// REG_PART_ID @ 0x00
#define PART_ID_SI41                0x41
#define PART_ID_SI42                0x42
#define PART_ID_SI43                0x43

// REG_IRQ_CFG @ 0x03
#define  ICG_INTOE                  0x01    // INT Output Enable.
                                            // INT_OE controls the INT pin drive
                                            //  0: INT pin is never driven
                                            //  1: INT pin driven low whenever an IRQ_STATUS 
                                            //     and its corresponding IRQ_ENABLE bits match
#define  ICG_INTMODE                0x02    // Interrupt Mode.
                                            //  The INT_MODE describes how the bits in the 
                                            //      IRQ_STATUS Registers are cleared.
                                            //  0: The IRQ_STATUS Register bits are set by the 
                                            //      internal sequencer and are sticky. It is the 
                                            //      host's responsibility to clear the interrupt 
                                            //      status bits in the IRQ_STATUS register
                                            //      to clear the interrupt.
                                            //  1: If the Parameter Field PSx_IM = 11, the internal 
                                            //      sequencer clears the INT pin automatically.
...
#define IM1_ALS_EXIT_WIN            0x01
#define IM1_ALS_ENTER_WIN           0x40
#define IM1_ALS_CHOOSE_IR           0x20
...
//
// REG_PS_LED21 @ 0x0F  LED2 Current is upper nibble
//                      LED1 Current is lower nibble 
//
// REG_PS_LED3  @ 0x10  LED3 Current is lower nibble
...
#define CMD_NOP                     0x00        // Forces a zero into the RESPONSE register
#define CMD_RESET                   0x01        // Performs a software reset of the firmware
#define CMD_BUSADDR                 0x02        // Modifies I2C address
#define CMD_PS_FORCE                0x05        // Forces a single PS measurement
#define CMD_ALS_FORCE               0x06        // Forces a single ALS measurement
#define CMD_PSALS_FORCE             0x07        // Forces a single PS and ALS measurement
#define CMD_PS_PAUSE                0x09        // Pauses autonomous PS
#define CMD_ALS_PAUSE               0x0A        // Pauses autonomous ALS
#define CMD_PSALS_PAUSE             0x0B        // Pauses PS and ALS
#define CMD_PS_AUTO                 0x0D        // Starts/Restarts an autonomous PS Loop
#define CMD_ALS_AUTO                0x0E        // Starts/Restarts an autonomous ALS Loop
#define CMD_PSALS_AUTO              0x0F        // Starts/Restarts autonomous ALS and PS loop
#define CMD_PARAM_MASK              0x1F        // Parameter bitfield mask
#define CMD_PARAM_QUERY             0x80        // Reads the parameter
#define CMD_PARAM_SET               0xA0        // Sets parameter 
#define CMD_PARAM_AND               0xC0        // Performs a bit-wise AND
#define CMD_PARAM_OR                0xE0        // Performs a bit-wise OR

// REG_RESPONSE @ 0x20
// Response Register Error Codes
#define RESP_NO_ERROR_MASK          0xF0        // The lower bit is a circular counter and 
                                                //  is incremented every time a command has 
                                                //  completed. This allows the host to keep 
                                                //  track of commands sent to the Si1141/42/43.
                                                //  The circular counter may be cleared using 
                                                //  the NOP command.
#define RESP_INVALID_SETTING        0x80        // An invalid setting was encountered.
#define RESP_PS1_ADC_OVERFLOW       0x88        // Indicates proximity channel one conversion overflow.
#define RESP_PS2_ADC_OVERFLOW       0x89        // Indicates proximity channel two conversion overflow.
#define RESP_PS3_ADC_OVERFLOW       0x8A        // Indicates proximity channel three conversion overflow
#define RESP_ALS_VIS_ADC_OVERFLOW   0x8C        // Indicates visible ambient light channel conversion overflow.
#define RESP_ALS_IR_ADC_OVERFLOW    0x8D        // Indicates infrared ambient light channel conversion overflow.
#define RESP_AUX_ADC_OVERFLOW       0x8E        // Indicates auxiliary channel conversion overflow
