...
#define EXTDIO_MAPPING              {16, 17, 18, 19, 20, 21, 0xFF, 0xFF, 0xFF, 0xFF, 26, 27, 28, 29, 30, 31, 8, 9, 10, 11, 12}
// End DIO Section

// PWM Section
#define EXTPWM_USED                 1
#define EXTPWM_BASE_OFFSET          13
#define EXTPWM_PORT2CFG             {1, 0, 0xFF, 0xFF, 8, 9 }   // Mapping PWM channel to configuration
                                                                // bits 7-3 Timer, bits 2-0 Channel
#define EXTPWM_PORT2DIO             {29, 30, 0xFF, 0xFF, 9,10}  // Mapping PWM channel to DIO
// End PWM Section
...
#define LED_Init()                  {DDRB |= (1<<PB5); PORTB &= ~(1<<PB5);}
...
#define OD_MAX_INDEX_LIST           20      // Size of identificators list, PC0-PC5 + ADC6/7 + Vbg + PD2-PD7 + PB0-PB4
